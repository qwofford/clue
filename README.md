...
<br><br>
A detailed account of my neice's strategy for playing clue is described in the Python notebook contained in this repository. Sample output from the simulation that was used to validate my strategy is found below.
<br><br>
